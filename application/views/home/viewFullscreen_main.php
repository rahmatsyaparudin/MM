<script>
	var options = {
		...
		fallbackLink: '<div class="row"><div class="col-md-3"></div><div class="col-md-6"><div class="alert alert-warning alert-dismissible"><i class="icon fa fa-warning"></i>This browser does not support inline PDFs. Please use Google Chrome or other browser that support inline pdf.</div><br><center><a href="<?=base_url()?>index.php/home/timeline" class="btn btn-primary btn-lg" data-toggle="modal" id="backToTimeline" data-placement="top" title="Back To Timeline"><i class="fa  fa-arrow-circle-left "></i> Back To Timeline</a></center></div></div>',
	};
